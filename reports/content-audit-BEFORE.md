...
| Missing canonical | 0 |
| Missing schema | 0 |
| Pages under 10 FAQs | 5 |
| Thin pages (<600 words) | 23 |
| Distinct duplicated paragraphs | 580 |
| Duplicated paragraph instances | 13500 |
| Distinct duplicated headings | 281 |
| Duplicated FAQ questions | 45 |
| Duplicated FAQ answers | 178 |
...
| pages | paragraph |
|---|---|
| 466 | Prices start from $0.30 per piece for large-volume orders. Final pricing depends on size, material, printing, … |
...
| 6 | Can you ship to multiple addresses in Texas? |
| 3 | What resolution do images need? |
| 3 | Can you ship to multiple addresses in California? |
| 3 | Can you ship to multiple addresses in Florida? |
...
|---|---|---|---|
| location | 40 | 780 | /locations/maryland/ ↔ /locations/philadelphia/ (0.583) |
| other | 417 | 26127 | /earbud-boxes/ ↔ /speaker-boxes/ (0.965) |
| blog | 10 | 0 | — |
| resource | 15 | 0 | — |
...
| /resources/sustainable-packaging-guide/ | 489 |
| /resources/printing-methods-guide/ | 494 |
| /resources/packaging-insert-guide/ | 503 |
| /resources/packaging-finishes-guide/ | 517 |
