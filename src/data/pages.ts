...
export const infoPages: InfoPage[] = [
  P({
    ...
    faqs: [
      ...
      { q: 'Do you have a minimum order?', a: 'Minimums are set by format and print method rather than by company policy. Digital runs start as low as 50 to 100 units; plate-based runs need more to absorb the setup cost.' },
  ...
  P({
    ...
    sections: [
      {
        ...
        steps: [
          ...
          { h: 'Production', d: 'Printing, die-cutting, finishing and assembly. Most formats complete in 8 to 15 business days after proof approval.' },
    ...
    faqs: [
      { q: 'How long does the whole process take?', a: 'For a straightforward first order, allow four to six weeks from enquiry to delivery. Production is 8 to 15 business days; the rest is specification, artwork and proofing.' },
  ...
  P({
    ...
    faqs: [
      { q: 'How long will my order take?', a: 'Production is 8 to 15 business days after artwork approval, plus transit. A first order typically takes four to six weeks end to end including specification and proofing.' },
  ...
  P({
    ...
    faqs: [
      { q: 'What is the minimum order quantity?', a: 'It depends on format and print method rather than company policy. Digital runs start as low as 50 pieces for stickers and 100 for mailer boxes. Plate-based runs generally need 1,000 or more to absorb the setup cost.' },
      ...
      { q: 'How long does production take?', a: 'Most orders complete in 8 to 15 business days after artwork approval, plus transit. Hand-assembled rigid boxes and specialty finishes take longer. Every quote carries a confirmed date.' },
