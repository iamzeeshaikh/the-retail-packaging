...
export const infoPages: InfoPage[] = [
  P({
    ...
    description: 'We manufacture custom retail packaging to order for brands in the US, UK, Canada and Australia, specifying structure and material around the product rather than selling from a stock catalogue.',
    eyebrow: 'About us',
    lede: 'The Retail Packaging produces made-to-order retail packaging for brands selling in the United States, the United Kingdom, Canada and Australia. Every dieline is cut for a specific product.',
    ...
    faqs: [
      ...
      { q: 'Which countries do you serve?', a: 'The United States, the United Kingdom, Canada and Australia. An order runs to the same timeline in all four — 3 to 5 business days of production after approval, 5 to 7 in transit. What changes is the freight cost, which we work out per consignment from weight, volume and destination.' },
  ...
  P({
    ...
    faqs: [
      ...
      { q: 'Where do you ship?', a: 'All fifty US states, plus the United Kingdom, Canada and Australia, on the same 5 to 7 business day transit after 3 to 5 days of production. Freight is priced separately based on weight, volume and destination.' },
