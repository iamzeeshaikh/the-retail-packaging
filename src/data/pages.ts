...
export const infoPages: InfoPage[] = [
  P({
    ...
    faqs: [
      ...
      { q: 'Which countries do you serve?', a: 'The United States, the United Kingdom, Canada and Australia. Production is the same wherever an order goes; what changes is the freight leg, which we quote per consignment once we know the weight, volume and destination.' },
  ...
  P({
    ...
    faqs: [
      ...
      { q: 'Where do you ship?', a: 'To all fifty US states, and by export freight to the United Kingdom, Canada and Australia. Freight is quoted separately based on weight, volume and destination.' },
