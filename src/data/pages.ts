...
export const infoPages: InfoPage[] = [
  P({
    ...
    faqs: [
      ...
      { q: 'Which countries do you serve?', a: 'The United States, the United Kingdom, Canada and Australia. An order runs to the same timeline in all four — 3 to 5 business days of production after approval, 2 to 7 in transit. What changes is the freight cost, which we work out per consignment from weight, volume and destination.' },
  ...
  P({
    ...
    faqs: [
      ...
      { q: 'Where do you ship?', a: 'All fifty US states, plus the United Kingdom, Canada and Australia, on the same 2 to 7 business day transit after 3 to 5 days of production. Freight is priced separately based on weight, volume and destination.' },
