...
export const legalPages: LegalPage[] = [
  {
    ...
    sections: [
      ...
      { h2: 'Contact', body: ['Questions about this policy, or requests about your data, can be sent to info@theretailpackaging.com, or by phone on +1 503-358-0443 in the US or +44 7458 651107 in the UK.'] },
    ],
  },
  {
  ...
  },
  {
    ...
    sections: [
      ...
      { h2: 'Reporting a problem', body: ['If any part of this site prevents you from doing something, tell us and we will fix it. Email info@theretailpackaging.com, or call +1 503-358-0443 in the US or +44 7458 651107 in the UK, and describe what you were trying to do.', 'We aim to respond within 5 business days and will offer an alternative way to complete the task in the meantime.'] },
    ],
  },
]
