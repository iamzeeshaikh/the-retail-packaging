...
export const statesB: Place[] = [
  S({
    ...
    faqs: [
      ...
      { q: 'Do you have a warehouse in Illinois?', a: 'No. We hold no premises in Illinois. Everything is made to order and shipped directly to your address.' },
  ...
  S({
    ...
    faqs: [
      ...
      { q: 'Do you operate a facility in Ohio?', a: 'No. We hold no premises in Ohio. Production runs through our manufacturing partners and ships directly to your address.' },
  ...
  S({
    ...
    faqs: [
      ...
      { q: 'Do you have a facility in Atlanta?', a: 'No. We hold no office, plant or warehouse in Georgia. Production runs through our manufacturing partners and ships to your address.' },
  ...
  S({
    ...
    faqs: [
      ...
      { q: 'Do you have a plant in North Carolina?', a: 'No. We hold no premises in the state. Production runs through our manufacturing partners and ships to your North Carolina address.' },
  ...
  S({
    ...
    faqs: [
      ...
      { q: 'Do you have a facility in Michigan?', a: 'No. We hold no premises in Michigan. Production runs through our manufacturing partners and ships directly to your address.' },
