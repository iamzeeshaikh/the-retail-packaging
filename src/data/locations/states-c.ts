...
export const statesC: Place[] = [
  ...
  S({
    ...
    faqs: [
      ...
      { q: 'Do you have premises in Massachusetts?', a: 'We manufacture through our production partners and ship direct — there is no office, plant or warehouse in the state. Production runs through our manufacturing partners and ships to your address.' },
