...
export const statesD: Place[] = [
  S({
    ...
    faqs: [
      ...
      { q: 'Can you hold stock for us?', a: 'We manufacture to order rather than warehousing finished goods. For a scheduled requirement we phase production and delivery against your consumption instead, which achieves the same thing without you paying to store it.' },
  ...
  S({
    ...
    faqs: [
      { q: 'Can a cardboard box keep contents cold?', a: 'No,. Paperboard and corrugated carry and protect; the thermal work is done by an insulated liner and a coolant. A heavier board adds no insulation. What it does add is resistance to the condensation that a cold pack generates.' },
