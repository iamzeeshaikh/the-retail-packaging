...
export const citiesA: Place[] = [
  C({
    ...
    faqs: [
      ...
      { q: 'Do you have a shop or office in New York City?', a: 'No. We hold no premises in the city or anywhere else in New York. We can post physical samples so you can assess the board and print in your own hands.' },
  ...
  C({
    ...
    faqs: [
      ...
      { q: 'Do you have a facility in Los Angeles?', a: 'No. We hold no office, plant or warehouse in Los Angeles. Production runs through our manufacturing partners and ships to your address.' },
  ...
  C({
    ...
    faqs: [
      ...
      { q: 'Do you have a warehouse in Chicago?', a: 'No. We hold no premises in Chicago. Production runs through our manufacturing partners and ships directly to your address.' },
  ...
  C({
    ...
    faqs: [
      ...
      { q: 'Do you have a facility in Houston?', a: 'No. We hold no premises in Houston. Production runs through our manufacturing partners and ships to your address.' },
  ...
  C({
    ...
    faqs: [
      ...
      { q: 'Do you have a warehouse in Phoenix?', a: 'No. We hold no premises in Phoenix. Production runs through our manufacturing partners and ships to your address.' },
