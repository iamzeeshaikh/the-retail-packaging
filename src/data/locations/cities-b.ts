...
export const citiesB: Place[] = [
  C({
    ...
    faqs: [
      ...
      { q: 'Do you have a shop in Philadelphia?', a: 'No. We hold no premises in Philadelphia or anywhere else. We post physical samples so you can assess the material directly.' },
  ...
  C({
    ...
    faqs: [
      ...
      { q: 'Do you have a facility in San Antonio?', a: 'No. We hold no premises in San Antonio or anywhere in Texas. Production runs through our manufacturing partners and ships to your address.' },
  ...
  C({
    ...
    faqs: [
      ...
      { q: 'Do you have a facility in San Diego?', a: 'No. We hold no premises in San Diego. Production runs through our manufacturing partners and ships to your address.' },
  ...
  C({
    ...
    faqs: [
      ...
      { q: 'Do you have a warehouse in Dallas?', a: 'No. We hold no premises in Dallas. Production runs through our manufacturing partners and ships to your address.' },
  ...
  C({
    ...
    faqs: [
      ...
      { q: 'Do you have a facility in Austin?', a: 'No. We hold no premises in Austin. We post physical samples so you can assess material and print directly.' },
  ...
  C({
    ...
    faqs: [
      ...
      { q: 'Do you have a facility in Jacksonville?', a: 'No. We hold no premises in Jacksonville or anywhere in Florida. Production runs through our manufacturing partners and ships to your address.' },
      ...
      { q: 'Can you hold stock for us?', a: 'No. We manufacture to order and hold no warehousing anywhere. For continuous requirements we phase production instead, which achieves a similar result without storage cost.' },
  ...
  C({
    ...
    faqs: [
      ...
      { q: 'Do you have a warehouse in Fort Worth?', a: 'No. We hold no premises in Fort Worth. Production runs through our manufacturing partners and ships to your address.' },
  ...
  C({
    ...
    faqs: [
      ...
      { q: 'Do you have a warehouse in Columbus?', a: 'No. We hold no premises in Columbus. Production runs through our manufacturing partners and ships directly to you.' },
  ...
  C({
    ...
    faqs: [
      ...
      { q: 'Do you have a facility in Charlotte?', a: 'No. We hold no premises in Charlotte. Production runs through our manufacturing partners and ships to your address.' },
  ...
  C({
    ...
    faqs: [
      ...
      { q: 'Do you have a facility in Indianapolis?', a: 'No. We hold no premises in Indianapolis. Production runs through our manufacturing partners and ships to your address.' },
  ...
  C({
    ...
    faqs: [
      { q: 'Can I have a fully recyclable coffee bag with a full barrier?', a: 'Not currently, and we would rather say so. The materials that block oxygen and moisture best are multi-layer laminates, which are hard to recycle for exactly that reason. Mono-material films are recyclable through store drop-off but give a shorter shelf life.' },
      ...
      { q: 'Do you have a facility in Seattle?', a: 'No. We hold no premises in Seattle. Production runs through our manufacturing partners and ships to your address.' },
  ...
  C({
    ...
    faqs: [
      ...
      { q: 'Do you have a facility in Denver?', a: 'No. We hold no premises in Denver. Production runs through our manufacturing partners and ships to your address.' },
  ...
  C({
    ...
    faqs: [
      ...
      { q: 'Do you have a facility in Boston?', a: 'No. We hold no premises in Boston. Production runs through our manufacturing partners and ships to your address.' },
  ...
  C({
    ...
    faqs: [
      ...
      { q: 'Do you have a facility in Atlanta?', a: 'No. We hold no office, plant or warehouse in Atlanta. Production runs through our manufacturing partners and ships to your address.' },
  ...
  C({
    ...
    faqs: [
      ...
      { q: 'Do you have a facility in Miami?', a: 'No. We hold no premises in Miami or anywhere in Florida. Production runs through our manufacturing partners and ships to your address.' },
