...
export const statesA: Place[] = [
  S({
    ...
    faqs: [
      ...
      { q: 'Do you have a facility in California?', a: 'No. We do not operate an office, plant or warehouse anywhere in California, and we would rather say so than imply otherwise. Production runs through our manufacturing partners and ships directly to your California address.' },
  ...
  S({
    ...
    faqs: [
      ...
      { q: 'Do you have a warehouse in Texas?', a: 'No. We hold no premises in Texas. Everything is made to order and shipped to your address, which is why we quote freight separately rather than folding it into a unit price.' },
  ...
  S({
    ...
    faqs: [
      ...
      { q: 'Do you have an office or plant in Florida?', a: 'No. We hold no premises in Florida. Production runs through our manufacturing partners and ships directly to your Florida address.' },
  ...
  S({
    ...
    faqs: [
      ...
      { q: 'Do you have a showroom or office in New York?', a: 'No. We hold no premises in New York. We can send physical samples so you can assess board, print and finish in your own hands before committing.' },
  ...
  S({
    ...
    faqs: [
      ...
      { q: 'Do you have a plant in Pennsylvania?', a: 'No. We hold no premises in the state. Production runs through our manufacturing partners and ships to your Pennsylvania address, usually within 2 to 4 business days of dispatch.' },
