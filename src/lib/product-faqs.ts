...
function universal(p: Product, t: Set<Trait>): Faq[] {
  ...
  return [
    ...
    { q: 'Where do you deliver?', a: `Across all 50 US states, and by export freight to the United Kingdom, Canada and Australia. Every run is made to order and shipped directly to your address rather than pulled from stock, so you receive current production rather than whatever has been sitting in a warehouse. Freight is quoted separately and depends on consignment size. ${r('delivery')}` },
