...
export const FORM_FACTORS: Record<FormFactorId, FormFactor> = {
  'folding-carton': {
    ...
    moq: 'Folding cartons run economically from 250 units, and unit cost drops sharply past 5,000.',
  ...
  'rigid-box': {
    ...
    moq: 'Rigid boxes are hand-assembled, so runs normally start at 100 units and stay competitive up to about 10,000.',
  ...
  'corrugated-box': {
    ...
    moq: 'Corrugated runs are efficient from 250 units, with meaningful savings at 2,500 and above.',
  ...
  mailer: {
    ...
    moq: 'Mailer boxes start at 100 units on digital and become notably cheaper past 1,000 on flexo.',
  ...
  'poly-mailer': {
    ...
    moq: 'Printed poly mailers are normally produced from 1,000 units, since the flexo plates need a run to pay for themselves.',
  ...
  'bubble-mailer': {
    ...
    moq: 'Printed bubble mailers typically start at 1,000 units per size.',
  ...
  'paper-bag': {
    ...
    moq: 'Printed paper bags are usually produced from 500 units, with better pricing past 2,500.',
  ...
  'tote-bag': {
    ...
    moq: 'Sewn totes are normally produced from 100 units, with fabric and handle colour locked at order.',
  ...
  pouch: {
    ...
    moq: 'Digitally printed pouches start around 500 units. Rotogravure needs 10,000 or more to justify the cylinders.',
  ...
  'paper-cup': {
    ...
    moq: 'Printed cups are produced from 1,000 units per size, and pricing improves noticeably at 10,000.',
  ...
  tray: {
    ...
    moq: 'Printed trays start at 1,000 units per size and price down meaningfully at 10,000.',
  ...
  sleeve: {
    ...
    moq: 'Sleeves are inexpensive to produce and normally run from 500 units.',
  ...
  label: {
    ...
    moq: 'Digital label runs start at 250 pieces per design, which suits small batches and seasonal variants.',
  ...
  sticker: {
    ...
    moq: 'Sticker runs start at 50 pieces per design, so short seasonal runs stay affordable.',
  ...
  insert: {
    ...
    moq: 'Board inserts run from 250 units. Foam inserts need a cutting die, so 500 units is a more efficient starting point.',
  ...
  display: {
    ...
    moq: 'Display units are usually produced from 250 pieces, since each design needs its own structural die.',
  ...
  tube: {
    ...
    moq: 'Paper tubes typically run from 500 units per size.',
  ...
  band: {
    ...
    moq: 'Belly bands run from 500 units and are one of the cheapest ways to add branding to a plain pack.',
  ...
  wrap: {
    ...
    moq: 'Printed wraps run from 1,000 sheets.',
