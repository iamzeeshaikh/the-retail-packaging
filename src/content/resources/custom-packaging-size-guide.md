---
title: Custom Packaging Size Guide
description: How to measure a product for packaging, what clearance to allow, how dimensions are quoted by format, and why small size changes affect price.
metaTitle: Custom Packaging Size Guide | Measuring Correctly
publishDate: 2026-05-20
updatedDate: 2026-08-11
keyword: packaging size guide
kind: howto
order: 50
heroProduct: cosmetic-boxes
heroAlt: Custom cosmetic boxes in several sizes showing how dimensions scale with product
faqs:
  - q: How much clearance should I allow around a product?
    a: Per side rather than per dimension, which is the error people make — 2 mm clearance means 2 mm each side, so 4 mm on the overall dimension. Rigid products need more than soft ones, and anything with manufacturing variance needs enough to absorb it.
  - q: Where exactly do I measure a product?
    a: At its widest point in each of three dimensions, in the state it will actually be packed. That means with the cap on, the pump extended if it ships that way, any applied label included, and the product folded the way it will be folded.
  - q: Can a smaller box really save meaningful money?
    a: On anything shipped to consumers, yes, and it is usually the largest saving available. Carriers bill on the greater of actual and volumetric weight, so an oversized mailer costs money on every order permanently. It typically dwarfs any material change.
  - q: What is sheet nesting and why does it affect my price?
...
The sample costs very little. Discovering the problem after a production run costs the run, and [the way tooling and setup costs behave](/resources/packaging-cost-factors/) explains why a resize after tooling is more expensive than it first appears.
